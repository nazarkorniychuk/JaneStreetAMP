...
def basic_checks(word1:str, word2:str)-> tuple[bool, str, str]:
    ...
    '''
    ### BEGIN SOLUTION
    word1 = ''.join(i for i in word1.lower() if ord(i) <= 122 and ord(i) >= 97)
    word2 = ''.join(i for i in word2.lower() if ord(i) <= 122 and ord(i) >= 97)
...
def is_anagram_exhaustive(word1:str, word2:str)->bool:
    ...
    '''
    ### BEGIN SOLUTION
    if not basic_checks(word1, word2)[0]:
        return False
    word1 = basic_checks(word1, word2)[1]
    word2 = basic_checks(word1, word2)[2]
